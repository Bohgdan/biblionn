      ...
      >
        <section style={{ width: "100%", maxWidth: "400px" }}>
          <header style={{ marginBottom: "2rem", textAlign: "center" }}>
            ...
            <p style={{ marginTop: "0.5rem", color: "#6b7280" }}>Створіть свій акаунт</p>
          </header>

          <form className="space-y-5" onSubmit={onSubmit}>
            <div>
              <label className="mb-2 block text-sm font-medium text-[#1a1f3c]" htmlFor="name">
                Ім&apos;я
              </label>
            ...
            <div>
              <label className="mb-2 block text-sm font-medium text-[#1a1f3c]" htmlFor="confirmPassword">
                Підтвердити пароль
              </label>
              <input
                id="confirmPassword"
